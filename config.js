...
//
//  介绍文案说明：每组 description 用 \n\n 分成两段，
//  第一段是「工作内容：……」，第二段是「要求：……」。
//  页面会把它们显示成两个独立的段落（要求永远从新的一行开始）。
//  注意：请保持 \n\n 写法（反斜杠 + n），不要把真实换行写进字符串。
// =====================================================================
...
window.FOUR_GROUPS_CONFIG = {
  ...
  groups: {
    talker: {
      ...
      description: "工作内容：挖掘教授、校友、创业者中能激发对话、推动变革的思想者，通过一次次对谈抽丝剥茧。将讲者的丰富经历淬炼为短小精悍的演讲，从初稿到登台，为每一场演讲保驾护航。\n\n要求：善于倾听，有共情力。在对接过程中与讲者产生深度链接。"
    },
    editor: {
      title: "编辑组",
      english: "EDITOR",
      description: "工作内容：参与策划TEDxSEU品牌播客录制、撰写公众号推文、剪辑演讲视频、运营B站小红书账号、为TED.com供稿视频。\n\n要求：文字敏感度或新媒体嗅觉（不会剪辑？资深学长学姐手把手教！）。"
    },
    designer: {
      title: "设计组",
      english: "DESIGNER",
      description: "工作内容：从年度大会的舞台背景、公众号头图到文创周边的制作，设计组用视觉语言定义活动气质，为观点锻造视觉骨骼。当色彩、线条成为思想的扩音器，传播便不再受限于语言的边疆。\n\n要求：审美在线，熟练使用PS/AI/PR等工具（零基础但热爱设计？Workshop培训助你成长！）。"
    },
    outreach: {
      title: "社群组",
      english: "OUTREACHER",
      description: "工作内容：对接校外企业赞助、联动各高校社团；为社员组织丰富多彩的团建活动；统筹财务，合理分配预算，确保每一分钱用在刀刃上。\n\n要求：沟通力MAX，热衷开拓资源，或对活动落地有极致细节控。"
    }
  },
